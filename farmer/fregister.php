 ...
 <footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    ...
                    <address>
                    Kondapi, Ongole<br>
		              PINCODE - 523270, Andhra Pradesh<br>		              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+919556769688"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="#"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="mailto:vtu19697@veltech.edu.in"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
