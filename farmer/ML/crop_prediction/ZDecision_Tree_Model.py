...
data = pd.read_csv(r'C:\xampp\htdocs\agriculture-portal-main\farmer\ML\crop_prediction\preprocessed2.csv')
...
joblib.dump(my_tree, r'C:\xampp\htdocs\agriculture-portal-main\farmer\ML\crop_prediction\filetest2.pkl')
